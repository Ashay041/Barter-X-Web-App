...
function startNetwork() {
	...
	COMPOSE_FILES="-f ${COMPOSE_BASE_FILE} -f ${COMPOSE_COUCH_FILE}" # -f ${COMPOSE_RAFT_FILE}"
...
function networkStop() {
	...
	docker-compose -f $COMPOSE_BASE_FILE down --volumes --remove-orphans #-f $COMPOSE_COUCH_FILE -f $COMPOSE_RAFT_FILE 
